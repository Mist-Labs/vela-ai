...
export const VELA_VAULT_ABI = parseAbi([
  "function totalAssets() view returns (uint256)",
  "function totalSupply() view returns (uint256)",
  "function totalDecisions() view returns (uint256)",
  "function agent() view returns (address)",
  "function recentDecisions(uint256 count) view returns ((bytes32 decisionHash, string explanation, string evidenceCID, uint256 timestamp, uint8 status, bytes32 attestationHash)[])",
]);
